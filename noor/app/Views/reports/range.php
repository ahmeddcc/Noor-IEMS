<?php
// صفحة تقرير الفترة الزمنية - تصميم طباعة مطابق لكشف الحساب
?>
<style>
    ...
    .report-date strong { font-size: 16px; font-weight: bold; color: #000 !important; }
...
<div class="range-wrapper">
    ...
    <div class="header-container">
        ...
        <div class="report-title">
            <h2>تقرير الفترة الزمنية</h2>
            <p>من <?php echo $from; ?> إلى <?php echo $to; ?></p>
        </div>

        <div class="report-date">
            <p>تاريخ الطباعة: <strong><?php echo date('d-m-Y'); ?></strong></p>
    ...
    <div class="summary-boxes">
        <div class="box">
            ...
            <div class="box-value income"><?php echo number_format($summary['income'], 2); ?> ج.م</div>
        </div>
        <div class="box">
            <div class="box-title">إجمالي المنصرف</div>
            <div class="box-value expense"><?php echo number_format($summary['expense'], 2); ?> ج.م</div>
        </div>
        <div class="box">
            <div class="box-title">إجمالي السلف</div>
            <div class="box-value advance"><?php echo number_format($summary['advances'], 2); ?> ج.م</div>
        </div>
        <div class="box">
            <div class="box-title">صافي الفترة</div>
            <div class="box-value" style="color: <?php echo $summary['net_balance'] >= 0 ? '#060' : '#c00'; ?> !important;">
                <?php echo number_format($summary['net_balance'], 2); ?> ج.م
            </div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <?php if (empty($transactions)): ?>
                <tr><td colspan="7" style="padding: 30px; color: #999;">لا توجد معاملات في هذه الفترة</td></tr>
            <?php endif; ?>
        </tbody>
        <tfoot>
            <tr class="total-row">
                ...
                <td colspan="2">
                    وارد: <?php echo number_format($summary['income'], 2); ?> | 
                    منصرف: <?php echo number_format($summary['expense'], 2); ?> | 
                    صافي: <?php echo number_format($summary['net_balance'], 2); ?>
                </td>
            </tr>
        </tfoot>
    </table>
